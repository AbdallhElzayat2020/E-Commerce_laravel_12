            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.faqs.questions.index') }}">
...
@push('js')
    ...
    <script>
        ...
        $('#yajra_table').DataTable({
            ...
            ajax: "{{ route('dashboard.faqs.questions.all') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    searchable: false,
                    orderable: false,
        ...
        $(document).on('click', '.delete_confirm_btn', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('dashboard.faqs.questions.destroy', 'id') }}".replace('id',
                            faq_question_id),
                        type: "DELETE",
                        data: {
                            _token: "{{ csrf_token() }}"
