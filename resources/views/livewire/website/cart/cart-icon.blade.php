        ...
        <div class="cart-submenu">
                ...
                @if($cartItems->count() > 0)
                    @foreach ($cartItems as $item)
                        <div class="wrapper" @click.stop>
                            ...
                            <button type="button" wire:click.prevent="removeItemFromCart({{ $item->id }})"
                                onclick="event.preventDefault(); event.stopPropagation(); return false;" class="close-btn"
                                style="cursor: pointer; background: none; border: none; padding: 0; margin: 0; display: flex; align-items: center; justify-content: center;">
            ...
            <div class="cart-wrapper-section">
                ...
                <div class="cart-btn">
                    ...
                    <a href="{{ route('website.checkout.index') }}" class="shop-btn checkout-btn">Checkout Now</a>
                </div>
            </div>
        </div>
    @endauth
