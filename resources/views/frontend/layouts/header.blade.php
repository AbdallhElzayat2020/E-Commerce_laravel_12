        ...
        <div class="container">
            <div class="header-center">
                ...
                <div class="header-cart-items">
                    ...
                    {{--  wishlist --}}
                    @livewire('website.wishlist.wish-list-icon')
                        ...
                        <div class="cart-submenu">
                            <div class="cart-wrapper-item">
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/product-img/product-img-1.webp"
                                                 alt="img">
                                        </div>
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/product-img/product-img-2.webp"
                                                 alt="img">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/product-img/product-img-4.webp"
                                                 alt="img">
                                        </div>
                                        <div class="wrapper-content">
                        ...
                        @auth
                            <div class="d-flex align-items-center" style="gap:12px;">
                                <div class="d-flex align-items-center" style="gap:8px;">
                                    <span
                                        style="display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border-radius:50%;background:#f6f6f8;color:#6e6d79;">
                                        <i class="fas fa-user" style="font-size:16px;"></i>
                                    </span>
                                    <a href="{{ route('website.profile.index') }}" style="color:#1d1d1d;text-decoration:none;font-weight:600;">
                                        {{ auth()->user()->name }}
                                    </a>
                                </div>
                                <form action="{{ route('logout') }}" method="POST" style="display:inline;">
                                    ...
                                    <button type="submit" class="shop-btn"
                                            style="padding:3px 10px;border-radius:6px;background:#AE1C9A;border:none;">
                                        <i class="fas fa-sign-out-alt" style="margin-right:8px;font-size:14px;"></i>
                                        <span style="font-weight:600;">{{ __('dashboard.logout') }}</span>
                                    </button>
                                </form>
                            </div>
                        @else
                                ...
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/category-img/dresses.webp"
                                                 alt="dress">
                                        </span>
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/category-img/bags.webp"
                                                 alt="Bags">
                                        </span>
                                        <span class="dropdown-text">
                                            Bags
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/category-img/sweaters.webp"
                                                 alt="sweaters">
                                        </span>
                                        <span class="dropdown-text">
                                            Sweaters
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/category-img/shoes.webp"
                                                 alt="sweaters">
                                        </span>
                                        <span class="dropdown-text">
                                            Boots
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/category-img/gift.webp"
                                                 alt="gift">
                                        </span>
                                        <span class="dropdown-text">
                                            Gifts
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/category-img/sneakers.webp"
                                                 alt="sneakers">
                                        </span>
                                        <span class="dropdown-text">
                                            Sneakers
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/category-img/watch.webp"
                                                 alt="watch">
                                        </span>
                                        <span class="dropdown-text">
                                            Watches
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/category-img/ring.webp"
                                                 alt="ring">
                                        </span>
                                        <span class="dropdown-text">
                                            Gold Ring
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/category-img/cap.webp"
                                                 alt="cap">
                                        </span>
                                        <span class="dropdown-text">
                                            Cap
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/category-img/glass.webp"
                                                 alt="glass">
                                        </span>
                                        <span class="dropdown-text">
                                            Sunglasses
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ asset('assets/frontend') }}/images/homepage-one/category-img/baby.webp"
                                                 alt="baby">
                                        </span>
                                        <span class="dropdown-text">
                                            Baby Shop
                            ...
                            <ul class="header-sub-menu">
                                @if ($pages->count() > 0)
                                    @foreach ($pages as $page)
                                        <li>
                                            <a href="{{ route('website.dynamic-page', $page->slug) }}">
